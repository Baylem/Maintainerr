...
export class AddCantinarrConnection1789943457371 implements MigrationInterface {
  name = 'AddCantinarrConnection1789943457371';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_settings" (
                ...
                "cantinarr_url" varchar,
                "cantinarr_api_key" varchar
            )
        `);
    await queryRunner.query(`
